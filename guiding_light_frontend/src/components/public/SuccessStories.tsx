        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {MOCK_STORIES.map((story, index) => (
            <motion.div
              ...
              className="bg-white rounded-[32px] overflow-hidden shadow-sm hover:shadow-xl transition-all border border-stone-100 flex flex-col group"
            >
              ...
              <div className="p-8 flex-1 flex flex-col">
                <div className="flex items-center text-stone-400 text-[10px] uppercase tracking-widest mb-4 space-x-6">
                  <span className="flex items-center font-bold"><Calendar className="w-3 h-3 mr-2" /> {story.date}</span>
                ...
                <button className="flex items-center text-[#4b5e52] font-bold text-xs uppercase tracking-widest hover:text-stone-900 transition-colors group/btn">
